object PONBB2Frm: TPONBB2Frm
        ...
        object QRBand19: TQRBand
          ...
          object QRLabel125: TQRLabel
            ...
            Caption = 
              ...
              ' / e-mail to PT. Kabana Textile Industries'
            Color = clWhite
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWindowText
            Font.Height = -11
      ...
      object QuickRep2: TQuickRep
        ...
        object TitleBand2: TQRBand
          ...
          object QRLabel20: TQRLabel
            ...
            AutoSize = True
            AutoStretch = False
            Caption = 'Dengan ini kami memesan barang sebagai berikut :'
            Color = clWhite
            Font.Charset = ANSI_CHARSET
            Font.Color = clWindowText
            Font.Height = -11
    ...
    object TabSheet2: TTabSheet
      ...
      object Panel5: TPanel
        ...
        object LookPPN: TwwDBComboBox
          ...
          OnCheckValue = LookPPNCheckValue
        ...
        object wwCheckBox_ORG: TwwCheckBox
          Left = 570
          Top = 65
          Width = 57
          Height = 17
      ...
      object wwDBGrid2: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'KD_ITEM'#9'11'#9'Kode'#9'T'#9'KEBUTUHAN BARANG/ BAHAN'
          'KETERANGAN'#9'80'#9'Diskripsi Item Barang'#9'T'#9'KEBUTUHAN BARANG/ BAHAN'
          'SATUAN_PO'#9'6'#9'Satuan'#9'T'#9'KEBUTUHAN BARANG/ BAHAN'
          ...
          'QTY_BATAL'#9'10'#9'Batal'#9'F'#9'PEMBELIAN'
          'TGL_PO'#9'9'#9'TANGGAL~DIKIRIM'#9'F')
        IniAttributes.Enabled = True
        IniAttributes.SaveToRegistry = True
        IniAttributes.FileName = 'Pismatex Master'
        IniAttributes.Delimiter = ';;'
    ...
    object TabSheet4: TTabSheet
      ...
      object wwDBGrid4: TwwDBGrid
        ...
        ControlType.Strings = (
          ...
          'STATUS;URL-Link')
        Selected.Strings = (
          'TANGGAL'#9'15'#9'TGL PO'#9'F'
          'TGL_INSERT'#9'15'#9'TGL CETAK PV'#9'F'
          'NO_PV'#9'16'#9'NO. PV'#9'F'
          'REKANAN2'#9'35'#9'REKANAN'#9'F'
          'MU'#9'3'#9'MATA~UANG'#9'F'
          'KURS'#9'10'#9'KURS'#9#9
          'DPP'#9'15'#9'DPP'#9'F'
          'BY_LAIN2'#9'15'#9'BIAYA~LAIN2'#9'F'
          'PPN'#9'8'#9'PPN'#9'F'#9'PPN'
          'NIL_PPN'#9'10'#9'NILAI'#9'F'#9'PPN'
          'AMOUNT'#9'15'#9'JUMLAH'#9'F'
          'STATUS'#9'8'#9'View'#9'F')
        IniAttributes.Enabled = True
        IniAttributes.SaveToRegistry = True
        IniAttributes.FileName = 'Pismatex Master'
        IniAttributes.Delimiter = ';;'
  ...
  object QDetail: TOracleDataSet
    ...
    ReadBuffer = 10
    Variables.Data = {
      03000000010000000A0000003A4E4F5F5245475F504F03000000040000000600
      000000000000}
    QBEDefinition.QBEFieldDefs = {
  ...
  object QBrowse: TOracleDataSet
    ...
    object QBrowsePPN2: TStringField
  ...
  object QAmbilNota: TOracleQuery
    SQL.Strings = (
      ...
      'where mu=:mu and kd_rekanan=:kd_rekanan and ispilih='#39'0'#39' and '
        ...
        '_nota AND kd_transaksi=:kd_transaksi));'
      'commit;'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
      03000000050000000A0000003A4E4F5F5245475F504F03000000000000000000
      ...
      00000000000000000D0000003A4B445F5452414E53414B534905000000000000
      0000000000}
    Left = 28
    Top = 425
  end
  ...
  object QTotalBrowse: TOracleDataSet
    ...
    Variables.Data = {
      0300000001000000080000003A4D59504152414D010000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      0400000003000000030000004450500100000000000300000050504E01000000
      000005000000544F54414C010000000000}
    Session = DMFrm.OS
    BeforeOpen = QBrowseBeforeOpen
    Left = 972
    Top = 49
  ...
  object QBrowse2: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      040000001A000000090000004E4F5F5245475F504F0100000000000A0000004B
  ...
  object QSubtotal: TOracleDataSet
    SQL.Strings = (
      'select sum(dpp) as dpp from pmtx02.pp_detail t'
      'where t.no_reg_po = :no_reg_po'
      ''
      '')
    Variables.Data = {
      03000000010000000A0000003A4E4F5F5245475F504F03000000000000000000
      0000}
    QBEDefinition.QBEFieldDefs = {040000000100000003000000445050010000000000}
    QueryAllRecords = False
    CountAllRecords = True
    Session = DMFrm.OS
    Left = 492
    Top = 385
    object QSubtotalDPP: TFloatField
      FieldName = 'DPP'
      DisplayFormat = '#,##0.0000;(#,##0.0000)'
    end
  end
  ...
  object QByLain2: TOracleDataSet
    SQL.Strings = (
      'select sum(by_lain2) as by_lain2 from pmtx02.po t'
      'where t.no_reg_po = :no_reg_po'
      ''
      '')
    Variables.Data = {
      03000000010000000A0000003A4E4F5F5245475F504F03000000000000000000
      0000}
    QBEDefinition.QBEFieldDefs = {04000000010000000800000042595F4C41494E32010000000000}
    QueryAllRecords = False
    CountAllRecords = True
    Session = DMFrm.OS
    Left = 572
    Top = 425
    object QByLain2BY_LAIN2: TFloatField
      FieldName = 'BY_LAIN2'
    end
  end
  ...
  object QBrowse3: TOracleDataSet
    ...
    Left = 188
    Top = 297
    object QBrowse3NO_REG_PO: TIntegerField
      FieldName = 'NO_REG_PO'
      Required = True
    end
    ...
    object QBrowse3PPN: TStringField
      FieldName = 'PPN'
      Size = 5
    end
    object QBrowse3ISPJK: TStringField
      FieldName = 'ISPJK'
      Size = 1
    end
    object QBrowse3STATUS: TStringField
      FieldName = 'STATUS'
      Size = 6
    end
    ...
    object QBrowse3NO_PV: TStringField
      FieldName = 'NO_PV'
      Size = 15
    end
    object QBrowse3AMOUNT: TFloatField
      FieldName = 'AMOUNT'
      DisplayFormat = '#,##0.##;(#,##0.##)'
    end
    object QBrowse3BY_LAIN2: TFloatField
      FieldName = 'BY_LAIN2'
      DisplayFormat = '#,##0.##;(#,##0.##)'
    end
    object QBrowse3DPP: TFloatField
      FieldName = 'DPP'
      DisplayFormat = '#,##0.##;(#,##0.##)'
    end
    object QBrowse3NIL_PPN: TFloatField
      FieldName = 'NIL_PPN'
      DisplayFormat = '#,##0.##;(#,##0.##)'
    end
    object QBrowse3REKANAN2: TStringField
      FieldName = 'REKANAN2'
      Size = 255
    end
  end
