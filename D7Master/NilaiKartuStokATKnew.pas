...
type
  TNilaiKartuStokATKnewFrm = class(TForm)
    Panel1: TPanel;
...
var
  NilaiKartuStokATKnewFrm: TNilaiKartuStokATKnewFrm;
...
procedure TNilaiKartuStokATKnewFrm.FormClose(Sender: TObject;
...
procedure TNilaiKartuStokATKnewFrm.FormCreate(Sender: TObject);
begin
  DMFrm.QLookSubBagian.Close;
  QLookItem.Close;
end;

procedure TNilaiKartuStokATKnewFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TNilaiKartuStokATKnewFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TNilaiKartuStokATKnewFrm.LookKonstruksiEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi.Open;
end;

procedure TNilaiKartuStokATKnewFrm.TabSheet2Show(Sender: TObject);
var
   v1, v2, v3, v4 : REAL;
begin
...
procedure TNilaiKartuStokATKnewFrm.QLookItemBeforeOpen(DataSet: TDataSet);
begin
  QLookItem.SetVariable('kd_jns_item',vkd_jns_item);
end;

procedure TNilaiKartuStokATKnewFrm.wwDBGrid1DblClick(Sender: TObject);
var
...
procedure TNilaiKartuStokATKnewFrm.ECariChange(Sender: TObject);
begin
...
procedure TNilaiKartuStokATKnewFrm.cbOtomatisClick(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TNilaiKartuStokATKnewFrm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
  x : Integer;
...
procedure TNilaiKartuStokATKnewFrm.FormShow(Sender: TObject);
begin
...
procedure TNilaiKartuStokATKnewFrm.QBrowseBeforeOpen(DataSet: TDataSet);
begin
  QBrowse.SetVariable('kd_jns_item',vkd_jns_item);
end;

procedure TNilaiKartuStokATKnewFrm.BitBtn5Click(Sender: TObject);
begin
...
procedure TNilaiKartuStokATKnewFrm.QLookSubBagianBeforeOpen(DataSet: TDataSet);
begin
  QLookSubBagian.SetVariable('kd_bag',vkd_bag);
end;

procedure TNilaiKartuStokATKnewFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TNilaiKartuStokATKnewFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TNilaiKartuStokATKnewFrm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vrecord_ke);
...
procedure TNilaiKartuStokATKnewFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=Trunc(EndOfTheMonth(VTglAwal.Date));
end;

procedure TNilaiKartuStokATKnewFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TNilaiKartuStokATKnewFrm.RadioGroup1Click(Sender: TObject);
begin
...
procedure TNilaiKartuStokATKnewFrm.ColumnHeaderBand2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  vrecord_ke:=0;
end;

procedure TNilaiKartuStokATKnewFrm.vHeightAfterUpClick(Sender: TObject);
begin
  case PageControl1.ActivePageIndex of
...
procedure TNilaiKartuStokATKnewFrm.BtnExportClick(Sender: TObject);
begin
  case PageControl1.ActivePageIndex of
  0 : begin
       if QBrowse.Active then
...
procedure TNilaiKartuStokATKnewFrm.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TNilaiKartuStokATKnewFrm.vOperandClick(Sender: TObject);
begin
  if vOperand.Caption='LIKE' then
    vOperand.Caption:='='
    else
...
procedure TNilaiKartuStokATKnewFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TNilaiKartuStokATKnewFrm.BitBtn2Click(Sender: TObject);
var
  vmybulan : string;
  i : Integer;
  w1, w2, w3, w4, w5, w6, w7, w8 : REAL;
...
procedure TNilaiKartuStokATKnewFrm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TNilaiKartuStokATKnewFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TNilaiKartuStokATKnewFrm.QBrowseCalcFields(DataSet: TDataSet);
var
  v1, v2 : real;
begin
...
procedure TNilaiKartuStokATKnewFrm.BitBtn3Click(Sender: TObject);
var
  i : integer;
begin
 { i:=0;
...
procedure TNilaiKartuStokATKnewFrm.BitBtn4Click(Sender: TObject);
begin
{  try
  QUpdateMutasi.Close;
...
procedure TNilaiKartuStokATKnewFrm.BitBtn6Click(Sender: TObject);
begin
{  QTutupTransaksi.Open;
...
procedure TNilaiKartuStokATKnewFrm.Label7Click(Sender: TObject);
begin
...
procedure TNilaiKartuStokATKnewFrm.QNilaiAwalBeforeOpen(DataSet: TDataSet);
begin
  QNilaiAwal.SetVariable('pkd_jns_item',vkd_jns_item);
end;

procedure TNilaiKartuStokATKnewFrm.QNilaiMasukBeforeOpen(DataSet: TDataSet);
begin
  QNilaiMasuk.SetVariable('pkd_jns_item',vkd_jns_item);
end;

procedure TNilaiKartuStokATKnewFrm.wwDBGrid2DblClick(Sender: TObject);
var
  myrvdDialog : TwwRecordViewDialog;
begin
  myrvdDialog:=TwwRecordViewDialog.Create(Nil);
...
procedure TNilaiKartuStokATKnewFrm.wwDBGrid2UpdateFooter(Sender: TObject);
begin
  QTotal.Close;
...
procedure TNilaiKartuStokATKnewFrm.QRiwayatTransaksiCalcFields(
  DataSet: TDataSet);
begin
...
procedure TNilaiKartuStokATKnewFrm.cbStokClick(Sender: TObject);
begin
  QBrowse.Filtered:=cbStok.Checked;
end;

procedure TNilaiKartuStokATKnewFrm.QBrowseFilterRecord(DataSet: TDataSet;
  var Accept: Boolean);
begin
...
procedure TNilaiKartuStokATKnewFrm.QTutupTransaksiBeforeOpen(
  DataSet: TDataSet);
begin
  QTutupTransaksi.SetVariable('pjns_item',vkd_jns_item);
end;

procedure TNilaiKartuStokATKnewFrm.TabSheet3Show(Sender: TObject);
var
 i : integer;
 R1, R2 : real;
begin
...
procedure TNilaiKartuStokATKnewFrm.QRBand3BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
 QRLabel20.Caption:=VTglAwal.Text+' s/d '+vTglAkhir.Text;
end;

procedure TNilaiKartuStokATKnewFrm.wwDBGrid4URLOpen(Sender: TObject;
  var URLLink: String; Field: TField; var UseDefault: Boolean);
begin
 Detail.Show;
end;

procedure TNilaiKartuStokATKnewFrm.DetailShow(Sender: TObject);
var
 i : integer;
 R1, R2 : real;
begin
...
procedure TNilaiKartuStokATKnewFrm.QRBand15BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  QRLabel49.Caption:='Periode : '+DateToStr(VTglAwal.Date)+' s/d '+DateToStr(vTglAkhir.Date);
end;

procedure TNilaiKartuStokATKnewFrm.QRBand10BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
{  QRLTitle.Caption:=LTitle.Caption;
  QRLPeriode.Caption:=VTglAwal.Text+' s/d '+vTglAkhir.Text;}
...
procedure TNilaiKartuStokATKnewFrm.QRBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
