...
type
  TNilaiKartuStokBBAKARnewFrm = class(TForm)
    Panel1: TPanel;
    ...
    procedure DetailShow(Sender: TObject);
...
var
  NilaiKartuStokBBAKARnewFrm: TNilaiKartuStokBBAKARnewFrm;

implementation

uses DM, MainBrowse, Main, Menus, XPROCS, DateUtils, Keterangan, Sisdur,
  NilaiKartuStokBB, NilaiKartuStokBBnew, NilaiKartuStokATKnew;

{$R *.dfm}

procedure TNilaiKartuStokBBAKARnewFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action:=caFree;
  NilaiKartuStokATKnewFrm:=Nil;
end;

procedure TNilaiKartuStokBBAKARnewFrm.FormCreate(Sender: TObject);
begin
  DMFrm.QLookSubBagian.Close;
  QLookItem.Close;
end;

procedure TNilaiKartuStokBBAKARnewFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TNilaiKartuStokBBAKARnewFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TNilaiKartuStokBBAKARnewFrm.LookKonstruksiEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi.Open;
end;

procedure TNilaiKartuStokBBAKARnewFrm.TabSheet2Show(Sender: TObject);
var
   v1, v2, v3, v4 : REAL;
begin
...
procedure TNilaiKartuStokBBAKARnewFrm.QLookItemBeforeOpen(DataSet: TDataSet);
begin
  QLookItem.SetVariable('kd_jns_item',vkd_jns_item);
end;

procedure TNilaiKartuStokBBAKARnewFrm.wwDBGrid1DblClick(Sender: TObject);
var
...
procedure TNilaiKartuStokBBAKARnewFrm.ECariChange(Sender: TObject);
begin
...
procedure TNilaiKartuStokBBAKARnewFrm.cbOtomatisClick(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TNilaiKartuStokBBAKARnewFrm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
  x : Integer;
...
procedure TNilaiKartuStokBBAKARnewFrm.FormShow(Sender: TObject);
begin
...
procedure TNilaiKartuStokBBAKARnewFrm.QBrowseBeforeOpen(DataSet: TDataSet);
begin
  QBrowse.SetVariable('kd_jns_item',vkd_jns_item);
end;

procedure TNilaiKartuStokBBAKARnewFrm.BitBtn5Click(Sender: TObject);
begin
...
procedure TNilaiKartuStokBBAKARnewFrm.QLookSubBagianBeforeOpen(DataSet: TDataSet);
begin
  QLookSubBagian.SetVariable('kd_bag',vkd_bag);
end;

procedure TNilaiKartuStokBBAKARnewFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TNilaiKartuStokBBAKARnewFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TNilaiKartuStokBBAKARnewFrm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vrecord_ke);
...
procedure TNilaiKartuStokBBAKARnewFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=Trunc(EndOfTheMonth(VTglAwal.Date));
end;

procedure TNilaiKartuStokBBAKARnewFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TNilaiKartuStokBBAKARnewFrm.RadioGroup1Click(Sender: TObject);
begin
...
procedure TNilaiKartuStokBBAKARnewFrm.ColumnHeaderBand2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  vrecord_ke:=0;
end;

procedure TNilaiKartuStokBBAKARnewFrm.vHeightAfterUpClick(Sender: TObject);
begin
  case PageControl1.ActivePageIndex of
...
procedure TNilaiKartuStokBBAKARnewFrm.BtnExportClick(Sender: TObject);
begin
  case PageControl1.ActivePageIndex of
  0 : begin
       if QBrowse.Active then
...
procedure TNilaiKartuStokBBAKARnewFrm.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TNilaiKartuStokBBAKARnewFrm.vOperandClick(Sender: TObject);
begin
  if vOperand.Caption='LIKE' then
    vOperand.Caption:='='
    else
...
procedure TNilaiKartuStokBBAKARnewFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TNilaiKartuStokBBAKARnewFrm.BitBtn2Click(Sender: TObject);
var
  vmybulan : string;
  i : Integer;
  w1, w2, w3, w4, w5, w6, w7, w8 : REAL;
...
procedure TNilaiKartuStokBBAKARnewFrm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TNilaiKartuStokBBAKARnewFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TNilaiKartuStokBBAKARnewFrm.QBrowseCalcFields(DataSet: TDataSet);
var
  v1, v2 : real;
begin
...
procedure TNilaiKartuStokBBAKARnewFrm.BitBtn3Click(Sender: TObject);
var
  i : integer;
begin
 { i:=0;
...
procedure TNilaiKartuStokBBAKARnewFrm.BitBtn4Click(Sender: TObject);
begin
{  try
  QUpdateMutasi.Close;
...
procedure TNilaiKartuStokBBAKARnewFrm.BitBtn6Click(Sender: TObject);
begin
{  QTutupTransaksi.Open;
...
procedure TNilaiKartuStokBBAKARnewFrm.Label7Click(Sender: TObject);
begin
...
procedure TNilaiKartuStokBBAKARnewFrm.QNilaiAwalBeforeOpen(DataSet: TDataSet);
begin
  QNilaiAwal.SetVariable('pkd_jns_item',vkd_jns_item);
end;

procedure TNilaiKartuStokBBAKARnewFrm.QNilaiMasukBeforeOpen(DataSet: TDataSet);
begin
  QNilaiMasuk.SetVariable('pkd_jns_item',vkd_jns_item);
end;

procedure TNilaiKartuStokBBAKARnewFrm.wwDBGrid2DblClick(Sender: TObject);
var
  myrvdDialog : TwwRecordViewDialog;
begin
  myrvdDialog:=TwwRecordViewDialog.Create(Nil);
...
procedure TNilaiKartuStokBBAKARnewFrm.wwDBGrid2UpdateFooter(Sender: TObject);
begin
  QTotal.Close;
...
procedure TNilaiKartuStokBBAKARnewFrm.QRiwayatTransaksiCalcFields(
  DataSet: TDataSet);
begin
...
procedure TNilaiKartuStokBBAKARnewFrm.cbStokClick(Sender: TObject);
begin
  QBrowse.Filtered:=cbStok.Checked;
end;

procedure TNilaiKartuStokBBAKARnewFrm.QBrowseFilterRecord(DataSet: TDataSet;
  var Accept: Boolean);
begin
...
procedure TNilaiKartuStokBBAKARnewFrm.QTutupTransaksiBeforeOpen(
  DataSet: TDataSet);
begin
  QTutupTransaksi.SetVariable('pjns_item',vkd_jns_item);
end;

procedure TNilaiKartuStokBBAKARnewFrm.TabSheet3Show(Sender: TObject);
var
 i : integer;
 R1, R2 : real;
begin
  ...
  QRekapPerMesin.SetVariable('jns_item','8');
  QRekapPerMesin.Open;
...
procedure TNilaiKartuStokBBAKARnewFrm.QRBand3BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
 QRLabel20.Caption:=VTglAwal.Text+' s/d '+vTglAkhir.Text;
end;

procedure TNilaiKartuStokBBAKARnewFrm.wwDBGrid4URLOpen(Sender: TObject;
  var URLLink: String; Field: TField; var UseDefault: Boolean);
begin
 Detail.Show;
end;

procedure TNilaiKartuStokBBAKARnewFrm.DetailShow(Sender: TObject);
var
 i : integer;
 R1, R2 : real;
begin
...
procedure TNilaiKartuStokBBAKARnewFrm.QRBand15BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  QRLabel49.Caption:='Periode : '+DateToStr(VTglAwal.Date)+' s/d '+DateToStr(vTglAkhir.Date);
end;

procedure TNilaiKartuStokBBAKARnewFrm.QRBand10BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
{  QRLTitle.Caption:=LTitle.Caption;
  QRLPeriode.Caption:=VTglAwal.Text+' s/d '+vTglAkhir.Text;}
...
procedure TNilaiKartuStokBBAKARnewFrm.QRBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TNilaiKartuStokBBAKARnewFrm.CheckBox1Click(Sender: TObject);
begin
  if CheckBox1.Checked=true then PanelEdit.Visible:=True else PanelEdit.Visible:=False;
end;

procedure TNilaiKartuStokBBAKARnewFrm.wwDBGrid2Enter(Sender: TObject);
begin
  QTransaksi.Close;
...
procedure TNilaiKartuStokBBAKARnewFrm.wwDBGrid2RowChanged(Sender: TObject);
begin
  QTransaksi.Close;
  QTransaksi.SetVariable('no_nota', QRiwayatTransaksiNO_NOTA.AsString);
  QTransaksi.Open;
...
procedure TNilaiKartuStokBBAKARnewFrm.wwDBGrid5CalcCellColors(
...
procedure TNilaiKartuStokBBAKARnewFrm.wwDBGrid5Enter(Sender: TObject);
begin
...
procedure TNilaiKartuStokBBAKARnewFrm.QTransaksiAfterDelete(
  DataSet: TDataSet);
begin
...
procedure TNilaiKartuStokBBAKARnewFrm.QTransaksiAfterPost(
  DataSet: TDataSet);
begin
  QRiwayatTransaksi.Refresh;
  wwDBGrid2.Refresh;
...
procedure TNilaiKartuStokBBAKARnewFrm.QTransaksiBeforeDelete(
  DataSet: TDataSet);
begin
  if QTransaksiISPOST.AsString='1' then
  begin
...
procedure TNilaiKartuStokBBAKARnewFrm.QDetailBeforeDelete(
  DataSet: TDataSet);
begin
  if QTransaksiISPOST.AsString='1' then
  begin
...
procedure TNilaiKartuStokBBAKARnewFrm.QDetailBeforeEdit(DataSet: TDataSet);
begin
  if QTransaksiISPOST.AsString='1' then
  begin
      ShowMessage('Maaf, data sudah di-POSTING, tidak bisa diubah !');
