object BKK2Frm: TBKK2Frm
  Left = 242
  Top = 210
  ActiveControl = GroupBox1
  AutoScroll = False
  Caption = 'Penerbitan Cek/ BG'
  ClientHeight = 526
  ClientWidth = 1045
  Color = clBtnFace
    ...
    object TabSheet1: TTabSheet
      ...
      object wwDBGrid1: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'NO_CEK'#9'13'#9'Nomer'#9'F'#9'DATA CEK BG'
          'JENIS'#9'3'#9'Jns'#9'F'#9'DATA CEK BG'
          'JTH_TEMPO'#9'11'#9'Jth. Tempo'#9'F'#9'DATA CEK BG'
          'ISCAIR'#9'6'#9'Cair'#9'F'#9'DATA CEK BG'
          'TGL_CAIR'#9'9'#9'Tgl. Cair'#9'F'#9'DATA CEK BG'
          'STATUS'#9'7'#9'Status'#9'F'#9'DATA CEK BG'
          'NO_REFF'#9'8'#9'NO_REFF'#9'F'
          ...
          'PENDING'#9'15'#9'Pending'#9'F'#9'NILAI'
          'CAIR'#9'15'#9'Cair'#9'F'#9'NILAI'
          'KURS'#9'5'#9'KURS'#9'F'
          'ISPOST'#9'6'#9'ISPOST'#9'F'
          'KD_CUSTOMER'#9'11'#9'CUSTOMER'#9'F'
    ...
    object TabSheet2: TTabSheet
      ...
      object wwDBGrid2: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'KETERANGAN'#9'45'#9'NAMA PERKIRAAN'#9'F'
  ...
  object QBrowse: TOracleDataSet
    ...
    Variables.Data = {
      ...
      5045524B320500000002000000250000000000}
    QBEDefinition.QBEFieldDefs = {
  ...
  object QCekCair: TOracleQuery
    ...
    Session = DMFrm.OS
    Variables.Data = {
      0300000004000000080000003A50535441545553050000000000000000000000
      0A0000003A5054474C5F434149520C0000000000000000000000080000003A50
      495343414952050000000000000000000000090000003A504E4F5F4E4F544105
