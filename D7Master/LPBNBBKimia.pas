...
var
  LPBNBBKimiaFrm: TLPBNBBKimiaFrm;
...
procedure TLPBNBBKimiaFrm.FormClose(Sender: TObject;
...
procedure TLPBNBBKimiaFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TLPBNBBKimiaFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TLPBNBBKimiaFrm.LookKonstruksiEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi.Open;
end;

procedure TLPBNBBKimiaFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure TLPBNBBKimiaFrm.QTransaksiAfterPost(DataSet: TDataSet);
begin
//  wwDBGrid2.SetFocus;
  TabSheet1.TabVisible:=QTransaksiISPOST.AsString='1';
end;

procedure TLPBNBBKimiaFrm.wwDBGrid2Enter(Sender: TObject);
begin
...
procedure TLPBNBBKimiaFrm.QTransaksiNewRecord(DataSet: TDataSet);
begin
  QSuplier.Close;
...
procedure TLPBNBBKimiaFrm.QTransaksiBeforePost(DataSet: TDataSet);
begin
...
procedure TLPBNBBKimiaFrm.TabSheet2Show(Sender: TObject);
begin
...
procedure TLPBNBBKimiaFrm.QTransaksiBeforeInsert(DataSet: TDataSet);
begin
...
procedure TLPBNBBKimiaFrm.QTransaksiBeforeEdit(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TLPBNBBKimiaFrm.DBText1Click(Sender: TObject);
begin
  InputBox('Copy Nomer','Klik Kanan --> Copy : ',QTransaksiNO_NOTA.AsString);
end;

procedure TLPBNBBKimiaFrm.DBText2Click(Sender: TObject);
var
  vno_reg_cari : String;
begin
...
procedure TLPBNBBKimiaFrm.BitBtn2Click(Sender: TObject);
begin
  rvdTTD.Execute;
end;

procedure TLPBNBBKimiaFrm.QLookLokasiBeforeOpen(DataSet: TDataSet);
begin
  QLookLokasi.SetVariable('kd_jns_item',QDetailKD_JNS_ITEM.AsString);
end;

procedure TLPBNBBKimiaFrm.wwDBGrid2CalcCellColors(Sender: TObject;
...
procedure TLPBNBBKimiaFrm.wwDBGrid1DblClick(Sender: TObject);
var
...
procedure TLPBNBBKimiaFrm.ECariChange(Sender: TObject);
begin
...
procedure TLPBNBBKimiaFrm.cbOtomatisClick(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TLPBNBBKimiaFrm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TLPBNBBKimiaFrm.FormShow(Sender: TObject);
begin
  VTglAwal.Date:=Trunc(DMFrm.QDateTimeVNOW.AsDateTime);
  QJnsTransaksi.Open;
end;

procedure TLPBNBBKimiaFrm.QBrowseBeforeOpen(DataSet: TDataSet);
begin
  QBrowse.SetVariable('kd_transaksi',QJnsTransaksiKD_TRANSAKSI.AsString);
end;

procedure TLPBNBBKimiaFrm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  vnomer:=0;
...
procedure TLPBNBBKimiaFrm.BitBtn5Click(Sender: TObject);
begin
...
procedure TLPBNBBKimiaFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TLPBNBBKimiaFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TLPBNBBKimiaFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  if QTransaksiISPOST.AsString='1' then
...
procedure TLPBNBBKimiaFrm.FormCloseQuery(Sender: TObject;
...
procedure TLPBNBBKimiaFrm.QDetailBeforeInsert(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TLPBNBBKimiaFrm.QTransaksiAfterDelete(DataSet: TDataSet);
begin
  if QTransaksi.IsEmpty then
    TabSheet1.TabVisible:=True;
end;

procedure TLPBNBBKimiaFrm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vrecord_ke);
...
procedure TLPBNBBKimiaFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=Trunc(EndOfTheMonth(VTglAwal.Date));
end;

procedure TLPBNBBKimiaFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TLPBNBBKimiaFrm.RadioGroup1Click(Sender: TObject);
begin
  case RadioGroup1.ItemIndex of
  0 : vRecord.Value:=40;
  1 : vRecord.Value:=20;
...
procedure TLPBNBBKimiaFrm.ColumnHeaderBand2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  vrecord_ke:=0;
end;

procedure TLPBNBBKimiaFrm.wwDBGrid2DblClick(Sender: TObject);
var
...
procedure TLPBNBBKimiaFrm.Button1Click(Sender: TObject);
begin
  wwDBGrid2DblClick(Nil);
end;

procedure TLPBNBBKimiaFrm.vHeightAfterUpClick(Sender: TObject);
begin
  case PageControl1.ActivePageIndex of
...
procedure TLPBNBBKimiaFrm.BtnExportClick(Sender: TObject);
begin
{azmi}
  case PageControl1.ActivePageIndex of
  0 :
...
procedure TLPBNBBKimiaFrm.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TLPBNBBKimiaFrm.vOperandClick(Sender: TObject);
begin
  if vOperand.Caption='LIKE' then
    vOperand.Caption:='='
    else
...
procedure TLPBNBBKimiaFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TLPBNBBKimiaFrm.BtnFormulasiClick(Sender: TObject);
begin
...
procedure TLPBNBBKimiaFrm.Label3Click(Sender: TObject);
begin
  DMFrm.QSisdur.Close;
...
procedure TLPBNBBKimiaFrm.LookSuplierCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
var
  vkota : string;
begin
...
procedure TLPBNBBKimiaFrm.LookSuplierEnter(Sender: TObject);
begin
QPO.close;
...
procedure TLPBNBBKimiaFrm.LookSuplierUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  QSuplier.Close;
  QSuplier.Open;
...
procedure TLPBNBBKimiaFrm.LookMUEnter(Sender: TObject);
begin
  DMFrm.QMU.Open;
end;

procedure TLPBNBBKimiaFrm.QDetailNewRecord(DataSet: TDataSet);
begin
  QDetailISPILIH.AsString:='0';
end;

procedure TLPBNBBKimiaFrm.wwDBGrid2UpdateFooter(Sender: TObject);
begin
//  QTotal.Close;
...
procedure TLPBNBBKimiaFrm.QuickRep2BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  vdpp:=0;
  vppn:=0;
...
procedure TLPBNBBKimiaFrm.PageHeaderBand2AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
  vfirst_page:=False;
end;

procedure TLPBNBBKimiaFrm.QBrowseDetailBeforeOpen(DataSet: TDataSet);
begin
//  QBrowseDetail.SetVariable('no_reg_po',QBrowseNO_REG_PO.AsInteger);
end;

procedure TLPBNBBKimiaFrm.DetailBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TLPBNBBKimiaFrm.QSuplierBeforeOpen(DataSet: TDataSet);
begin
...
procedure TLPBNBBKimiaFrm.QDetailCalcFields(DataSet: TDataSet);
begin
...
procedure TLPBNBBKimiaFrm.QDetailBeforePost(DataSet: TDataSet);
begin
  QDetailSATUAN.AsString:=QDetailSATUAN2.AsString;
end;

procedure TLPBNBBKimiaFrm.LookLokasiEnter(Sender: TObject);
begin
  QLookLokasi.Close;
  QLookLokasi.Open;
end;

procedure TLPBNBBKimiaFrm.LookLokasiCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TLPBNBBKimiaFrm.QPOBeforeOpen(DataSet: TDataSet);
begin
  QPO.SetVariable('NO_NOTA',ENoNota.Text);
end;

procedure TLPBNBBKimiaFrm.QRGroup2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vnomer);
...
procedure TLPBNBBKimiaFrm.BitBtn4Click(Sender: TObject);
begin
...
procedure TLPBNBBKimiaFrm.LookBBEnter(Sender: TObject);
begin
  DMFrm.QBBKimia.Open;
end;

procedure TLPBNBBKimiaFrm.LookBBCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
      QDetailKETERANGAN.AsString:=DMFrm.QBBKimiaNAMA_ITEM.AsString;
  end;
end;

procedure TLPBNBBKimiaFrm.wwDBGrid3DblClick(Sender: TObject);
...
procedure TLPBNBBKimiaFrm.wwDBGrid3TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
 if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TLPBNBBKimiaFrm.Vtglawal2Change(Sender: TObject);
begin
 vTglAkhir2.Date:=Trunc(EndOfTheMonth(VTglAwal2.Date));
end;

procedure TLPBNBBKimiaFrm.Vtglakhir2Change(Sender: TObject);
begin
...
procedure TLPBNBBKimiaFrm.cbotomatis2Click(Sender: TObject);
begin
...
procedure TLPBNBBKimiaFrm.dbcfield2Enter(Sender: TObject);
...
procedure TLPBNBBKimiaFrm.Voperand2Click(Sender: TObject);
begin
...
procedure TLPBNBBKimiaFrm.cbtanggal2Click(Sender: TObject);
begin
...
procedure TLPBNBBKimiaFrm.ecari2Change(Sender: TObject);
begin
  if cbOtomatis2.Checked then
  begin
...
procedure TLPBNBBKimiaFrm.Btn_filterClick(Sender: TObject);
...
procedure TLPBNBBKimiaFrm.TabSheet3Show(Sender: TObject);
begin
