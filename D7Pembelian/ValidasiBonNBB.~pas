...
type
  TValidasiBonNBBFrm = class(TForm)
    Panel1: TPanel;
...
var
  ValidasiBonNBBFrm: TValidasiBonNBBFrm;
...
procedure TValidasiBonNBBFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action:=caFree;
  ValidasiBonNBBFrm:=Nil;
end;

procedure TValidasiBonNBBFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TValidasiBonNBBFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TValidasiBonNBBFrm.LookKonstruksiEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi.Open;
end;

procedure TValidasiBonNBBFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure TValidasiBonNBBFrm.QTransaksiAfterPost(DataSet: TDataSet);
begin
  wwDBGrid2.SetFocus;
  TabSheet1.TabVisible:=QTransaksiISPOST.AsString='1';
end;

procedure TValidasiBonNBBFrm.wwDBGrid2Enter(Sender: TObject);
begin
...
procedure TValidasiBonNBBFrm.QTransaksiNewRecord(DataSet: TDataSet);
begin
...
procedure TValidasiBonNBBFrm.QTransaksiBeforePost(DataSet: TDataSet);
begin
...
procedure TValidasiBonNBBFrm.TabSheet2Show(Sender: TObject);
begin
...
procedure TValidasiBonNBBFrm.QDetailNewRecord(DataSet: TDataSet);
begin
  QDetailOPR_INSERT.AsString:=DMFrm.QUserNAMA_USER.AsString;
  //QDetailTANGGAL.AsDateTime:=QTransaksiTANGGAL.AsDateTime;
end;

procedure TValidasiBonNBBFrm.QTransaksiBeforeInsert(DataSet: TDataSet);
begin
...
procedure TValidasiBonNBBFrm.QTransaksiBeforeEdit(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TValidasiBonNBBFrm.DBText2Click(Sender: TObject);
var
  vno_reg_cari : String;
begin
...
procedure TValidasiBonNBBFrm.BitBtn2Click(Sender: TObject);
begin
  rvdTTD.Execute;
end;

procedure TValidasiBonNBBFrm.wwDBGrid2CalcCellColors(Sender: TObject;
...
procedure TValidasiBonNBBFrm.wwDBGrid1DblClick(Sender: TObject);
var
...
procedure TValidasiBonNBBFrm.ECariChange(Sender: TObject);
begin
...
procedure TValidasiBonNBBFrm.cbOtomatisClick(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TValidasiBonNBBFrm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TValidasiBonNBBFrm.FormShow(Sender: TObject);
begin
  VTglAwal.Date:=Trunc(DMFrm.QDateTimeVNOW.AsDateTime);
  QJnsTransaksi.Open;
end;

procedure TValidasiBonNBBFrm.QBrowseBeforeOpen(DataSet: TDataSet);
begin
  QBrowse.SetVariable('kd_transaksi',QJnsTransaksiKD_TRANSAKSI.AsString);
end;

procedure TValidasiBonNBBFrm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  QRLTitle.Caption:=UpperCase(QJnsTransaksiNAMA_TRANSAKSI.AsString);
end;

procedure TValidasiBonNBBFrm.BitBtn5Click(Sender: TObject);
begin
...
procedure TValidasiBonNBBFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TValidasiBonNBBFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TValidasiBonNBBFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  if QTransaksiISPOST.AsString='1' then
  begin
...
procedure TValidasiBonNBBFrm.FormCloseQuery(Sender: TObject;
...
procedure TValidasiBonNBBFrm.QDetailBeforeInsert(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TValidasiBonNBBFrm.QTransaksiAfterDelete(DataSet: TDataSet);
begin
  if QTransaksi.IsEmpty then
    TabSheet1.TabVisible:=True;
end;

procedure TValidasiBonNBBFrm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vrecord_ke);
...
procedure TValidasiBonNBBFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=Trunc(EndOfTheMonth(VTglAwal.Date));
end;

procedure TValidasiBonNBBFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TValidasiBonNBBFrm.RadioGroup1Click(Sender: TObject);
begin
  case RadioGroup1.ItemIndex of
  0 : vRecord.Value:=40;
  1 : vRecord.Value:=20;
...
procedure TValidasiBonNBBFrm.ColumnHeaderBand2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  vrecord_ke:=0;
end;

procedure TValidasiBonNBBFrm.wwDBGrid2DblClick(Sender: TObject);
var
...
procedure TValidasiBonNBBFrm.Button1Click(Sender: TObject);
begin
  wwDBGrid2DblClick(Nil);
end;

procedure TValidasiBonNBBFrm.vHeightAfterUpClick(Sender: TObject);
begin
  case PageControl1.ActivePageIndex of
...
procedure TValidasiBonNBBFrm.BtnExportClick(Sender: TObject);
begin
  if QBrowse.Active then
  begin
...
procedure TValidasiBonNBBFrm.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TValidasiBonNBBFrm.vOperandClick(Sender: TObject);
begin
  if vOperand.Caption='LIKE' then
    vOperand.Caption:='='
    else
...
procedure TValidasiBonNBBFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TValidasiBonNBBFrm.Label3Click(Sender: TObject);
begin
  DMFrm.QSisdur.Close;
...
procedure TValidasiBonNBBFrm.QLookLokasiBeforeOpen(DataSet: TDataSet);
begin
  QLookLokasi.SetVariable('kd_jns_item',QDetailKD_JNS_ITEM.AsString);
end;

procedure TValidasiBonNBBFrm.LookLokasiCloseUp(Sender: TObject;
...
procedure TValidasiBonNBBFrm.LookLokasiEnter(Sender: TObject);
begin
  QLookLokasi.Close;
  QLookLokasi.Open;
end;

procedure TValidasiBonNBBFrm.BtnFormulasiClick(Sender: TObject);
begin
...
procedure TValidasiBonNBBFrm.LookKoreksiEnter(Sender: TObject);
begin
  QJnsKoreksi.Open;
end;

procedure TValidasiBonNBBFrm.LookMesinCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TValidasiBonNBBFrm.LookMesinEnter(Sender: TObject);
begin
  QLookMesin.Open;
end;

procedure TValidasiBonNBBFrm.LookMesinUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  QLookMesin.Close;
  QLookMesin.Open;
...
procedure TValidasiBonNBBFrm.wwCheckBox1Click(Sender: TObject);
begin
...
procedure TValidasiBonNBBFrm.QRBand3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  if QTransaksiISPOST.AsString='1' then
  begin
...
procedure TValidasiBonNBBFrm.QRBand4BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  vrecord_ke:=0;
end;

procedure TValidasiBonNBBFrm.QRBand5BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vrecord_ke);
  DetailBand2.ForceNewPage:=(vrecord_ke>Round(vRecord.Value)-1);
