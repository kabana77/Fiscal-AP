object ValidasiBonKMSFrm: TValidasiBonKMSFrm
    ...
    object TabSheet2: TTabSheet
      ...
      object wwDBGrid2: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'ID_SUB_BAG'#9'6'#9'SUB BAG'#9'T'#9'BEBANKAN KE'
          ...
          'SATUAN'#9'5'#9'SATUAN'#9'T'#9'BARANG/ BAHAN'
  ...
  object QBrowse: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      454B5349010000000000070000004E4F5F52454646010000000000}
    QueryAllRecords = False
    CountAllRecords = True
    Session = DMFrm.OS
  ...
  object QAmbilNota: TOracleQuery
    SQL.Strings = (
      ...
      '  insert into pmtx02.vbon_barang_detail'
        ...
        '_item, qty, qty_validasi, 0, id_bag, id_sub_bag, '#39'0001'#39', '#39'08'#39', '#39 +
        '-'#39' from pmtx02.vbon_barang_nbb'
