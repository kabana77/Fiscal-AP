...
type
  TValidasiBonKMSFrm = class(TForm)
    Panel1: TPanel;
...
var
  ValidasiBonKMSFrm: TValidasiBonKMSFrm;
...
procedure TValidasiBonKMSFrm.FormClose(Sender: TObject;
...
procedure TValidasiBonKMSFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TValidasiBonKMSFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TValidasiBonKMSFrm.LookKonstruksiEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi.Open;
end;

procedure TValidasiBonKMSFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure TValidasiBonKMSFrm.QTransaksiAfterPost(DataSet: TDataSet);
begin
  wwDBGrid2.SetFocus;
  TabSheet1.TabVisible:=QTransaksiISPOST.AsString='1';
end;

procedure TValidasiBonKMSFrm.wwDBGrid2Enter(Sender: TObject);
begin
...
procedure TValidasiBonKMSFrm.QTransaksiNewRecord(DataSet: TDataSet);
begin
...
procedure TValidasiBonKMSFrm.QTransaksiBeforePost(DataSet: TDataSet);
begin
...
procedure TValidasiBonKMSFrm.TabSheet2Show(Sender: TObject);
begin
...
procedure TValidasiBonKMSFrm.QDetailNewRecord(DataSet: TDataSet);
begin
  QDetailOPR_INSERT.AsString:=DMFrm.QUserNAMA_USER.AsString;
end;

procedure TValidasiBonKMSFrm.QTransaksiBeforeInsert(DataSet: TDataSet);
begin
...
procedure TValidasiBonKMSFrm.QTransaksiBeforeEdit(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TValidasiBonKMSFrm.DBText1Click(Sender: TObject);
begin
  InputBox('Copy Nomer','Klik Kanan --> Copy : ',QTransaksiNO_NOTA.AsString);
end;

procedure TValidasiBonKMSFrm.DBText2Click(Sender: TObject);
var
  vno_reg_cari : String;
begin
...
procedure TValidasiBonKMSFrm.BitBtn2Click(Sender: TObject);
begin
  rvdTTD.Execute;
end;

procedure TValidasiBonKMSFrm.wwDBGrid2CalcCellColors(Sender: TObject;
...
procedure TValidasiBonKMSFrm.wwDBGrid1DblClick(Sender: TObject);
var
...
procedure TValidasiBonKMSFrm.ECariChange(Sender: TObject);
begin
...
procedure TValidasiBonKMSFrm.cbOtomatisClick(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TValidasiBonKMSFrm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TValidasiBonKMSFrm.FormShow(Sender: TObject);
begin
  VTglAwal.Date:=Trunc(DMFrm.QDateTimeVNOW.AsDateTime);
  QJnsTransaksi.Open;
end;

procedure TValidasiBonKMSFrm.QBrowseBeforeOpen(DataSet: TDataSet);
begin
  QBrowse.SetVariable('kd_transaksi',QJnsTransaksiKD_TRANSAKSI.AsString);
end;

procedure TValidasiBonKMSFrm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  QRLTitle.Caption:=UpperCase(QJnsTransaksiNAMA_TRANSAKSI.AsString);
end;

procedure TValidasiBonKMSFrm.BitBtn5Click(Sender: TObject);
begin
...
procedure TValidasiBonKMSFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TValidasiBonKMSFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TValidasiBonKMSFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  if QTransaksiISPOST.AsString='1' then
...
procedure TValidasiBonKMSFrm.FormCloseQuery(Sender: TObject;
...
procedure TValidasiBonKMSFrm.QDetailBeforeInsert(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TValidasiBonKMSFrm.QTransaksiAfterDelete(DataSet: TDataSet);
begin
  if QTransaksi.IsEmpty then
    TabSheet1.TabVisible:=True;
end;

procedure TValidasiBonKMSFrm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vrecord_ke);
...
procedure TValidasiBonKMSFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=Trunc(EndOfTheMonth(VTglAwal.Date));
end;

procedure TValidasiBonKMSFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TValidasiBonKMSFrm.RadioGroup1Click(Sender: TObject);
begin
  case RadioGroup1.ItemIndex of
  0 : vRecord.Value:=40;
  1 : vRecord.Value:=20;
...
procedure TValidasiBonKMSFrm.ColumnHeaderBand2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  vrecord_ke:=0;
end;

procedure TValidasiBonKMSFrm.wwDBGrid2DblClick(Sender: TObject);
var
...
procedure TValidasiBonKMSFrm.Button1Click(Sender: TObject);
begin
  wwDBGrid2DblClick(Nil);
end;

procedure TValidasiBonKMSFrm.vHeightAfterUpClick(Sender: TObject);
begin
  case PageControl1.ActivePageIndex of
...
procedure TValidasiBonKMSFrm.BtnExportClick(Sender: TObject);
begin
  if QBrowse.Active then
  begin
...
procedure TValidasiBonKMSFrm.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TValidasiBonKMSFrm.vOperandClick(Sender: TObject);
begin
  if vOperand.Caption='LIKE' then
    vOperand.Caption:='='
    else
...
procedure TValidasiBonKMSFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TValidasiBonKMSFrm.Label3Click(Sender: TObject);
begin
  DMFrm.QSisdur.Close;
...
procedure TValidasiBonKMSFrm.QLookLokasiBeforeOpen(DataSet: TDataSet);
begin
  QLookLokasi.SetVariable('kd_jns_item',QDetailKD_JNS_ITEM.AsString);
end;

procedure TValidasiBonKMSFrm.LookLokasiCloseUp(Sender: TObject;
...
procedure TValidasiBonKMSFrm.LookLokasiEnter(Sender: TObject);
begin
  QLookLokasi.Close;
  QLookLokasi.Open;
end;

procedure TValidasiBonKMSFrm.BtnFormulasiClick(Sender: TObject);
begin
  if (QTransaksiNO_REFF.AsString='')  then
    ShowMessage('No. Bukti Bon harus diisi !')
    else
 begin
// label18.caption:=copy(QTransaksiNO_REFF.AsString,1,3);
...
procedure TValidasiBonKMSFrm.LookKoreksiEnter(Sender: TObject);
begin
  QJnsKoreksi.Open;
end;

procedure TValidasiBonKMSFrm.LookMesinCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TValidasiBonKMSFrm.LookMesinEnter(Sender: TObject);
begin
  QLookMesin.Open;
end;

procedure TValidasiBonKMSFrm.LookMesinUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  QLookMesin.Close;
  QLookMesin.Open;
